...
| -------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `home-hero-warm.webp`            | Ein Grundschulkind arbeitet vertieft und aus eigenem Antrieb mit Montessori-Mathematikmaterial; eine Pädagogin begleitet es im Hintergrund mit warmem Blick, einem leisen Lächeln und entspannter, zugewandter Haltung. Hochformatiger, responsiv beschneidbarer Hero. Die frühere Variante bleibt als `home-hero.webp` erhalten. |
